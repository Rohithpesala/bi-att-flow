...
## Train Full dataset
python -m basic.cli --mode train --noload --out_base_dir "out/nqa-sq-tuning-01-10/" --joint_ratio 0.1 --init_lr 0.1 --batch_size 60 --num_steps 10000 -device /gpu:0 --device_type gpu --num_gpus 1

## Testing on dataset
python -m basic.cli --data_dir "data/newsqa/" --out_base_dir "out/nqa-sq-tuning-01-10/" --device /gpu:0 --device_type gpu --num_gpus 1
