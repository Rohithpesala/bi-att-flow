...
#SBATCH --output=50s-test-j-nqa-sq-bidaf-txl-1-%A.out
#SBATCH --error=50s-test-j-nqa-sq-bidaf-txl-1-%A.err
#SBATCH --gres=gpu:1
#SBATCH --mem=80000
...
## Train Full dataset
# python -m basic.cli --mode train --noload --out_base_dir "out/nqa-sq-50/" --joint_ratio 0.5 --batch_size 60 --num_steps 20000 -device /gpu:0 --device_type gpu --num_gpus 1

## Testing on dataset
python -m basic.cli --data_dir "data/squad/" --out_base_dir "out/nqa-sq-50/" --device /gpu:0 --device_type gpu --num_gpus 1
