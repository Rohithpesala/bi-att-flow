#!/bin/bash
#
#SBATCH --job-name=5j-1gpu-joint-newsqa-bidaf-tf
#SBATCH --partition=m40-long
#SBATCH --output=5n-test-j-nqa-sq-bidaf-txl-1-%A.out
#SBATCH --error=5n-test-j-nqa-sq-bidaf-txl-1-%A.err
#SBATCH --gres=gpu:1
#SBATCH --mem=80000
...
## Train Full dataset
# python -m basic.cli --mode train --noload --out_base_dir "out/nqa-sq-5/" --joint_ratio 0.05 --batch_size 60 --num_steps 20000 -device /gpu:0 --device_type gpu --num_gpus 1

## Testing on dataset
python -m basic.cli --data_dir "data/newsqa/" --out_base_dir "out/nqa-sq-5/" --device /gpu:0 --device_type gpu --num_gpus 1
