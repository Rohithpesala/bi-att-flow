...
#SBATCH --output=2-gpu-bidaf-m40s-%A.out
#SBATCH --error=2-gpu-bidaf-m40s-%A.err
#SBATCH --mem=50000
#SBATCH --gres=gpu:2
...
#python -m basic.cli --mode train --noload --debug  --batch_size 30 --device /gpu:0 --device_type gpu --num_gpus 2 --len_opt --cluster --data_dir "data/marco" --out_base_dir "out_marco"

## Train Full dataset
python -m basic.cli --mode train --noload --batch_size 30 --num_steps 10000 -device /gpu:0 --device_type gpu --num_gpus 2 --len_opt --cluster --data_dir "data/marco" --out_base_dir "out_marco_train"

## Testing on dataset
python -m basic.cli --mode test -device /gpu:0 --device_type gpu --num_gpus 2 --len_opt --cluster
