#!/bin/bash
#
#SBATCH --job-name=100j-multi-opt-gpu-newsqa-bidaf-tf
#SBATCH --partition=m40-long
#SBATCH --output=100j-2-gpu-newsqa-bidaf-m40l-%A.out
#SBATCH --error=100j-2-gpu-newsqa-bidaf-m40l-%A.err
#SBATCH --mem=60000
#SBATCH --gres=gpu:2
...
## Train Full dataset
python -m basic.cli --mode train --noload --batch_size 30 --out_base_dir "out/multi-nqa-sq-100/" --joint_ratio 1.0 --num_steps 10000 -device /gpu:0 --device_type gpu --num_gpus 2 --len_opt --cluster
