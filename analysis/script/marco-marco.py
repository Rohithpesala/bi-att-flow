...
def main():
    ...
    answer_file = open("../../out/basic/marco_train/answer/marco_train_marco_test.json")
    train_file = open("../../data/marco/train-v1.1.json")
    dev_file = open("../../data/marco/data_test.json")
